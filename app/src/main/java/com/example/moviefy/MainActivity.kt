...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var favMoviesAdapter: FilmAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        favMovies = findViewById(R.id.favorite)
        favMoviesLayoutMgr = LinearLayoutManager(
            this,
            LinearLayoutManager.HORIZONTAL,
            false
        )
        favMovies.layoutManager = favMoviesLayoutMgr
        favMoviesAdapter = FilmAdapter() { movie -> showMovieDetails(movie) }
...
//    }
    ...
    private fun loadFav(){
        val flist = AppDatabase.getInstance(this).Dao().get()
        favMoviesAdapter.updateData(flist)
    }

    private fun showMovieDetails(movie: Movie) {
        val intent = Intent(this, MovieDetailsActivity::class.java)
        intent.putExtra(ID.toString(), movie.id)
